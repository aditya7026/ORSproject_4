...
public class PropertyReader {
	private static ResourceBundle rb = ResourceBundle
            .getBundle("in.co.rays.project_4.properties.System");
    ...
    public static void main(String[] args) {
    	...
    	String[] params = {"First Name","number"," special character"," "};
        System.out.println(PropertyReader.getValue("error.name", params));
    }
}
